...
public class AuthenticationControllerTest extends AbstractControllerTest {
	...
	public void login() throws Exception {
		...
		authenticate(loginUser).andExpect(status().isOk());
	}

	public ResultActions authenticate(LoginUser loginUser) throws Exception {
		return this.executePostRequest("/token/generate-token", loginUser);
	}
